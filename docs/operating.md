...
Agents | `agent rules`, `agent rule drift` | Each agent's deny rules present, absent, or carried in an extension; and rules an earlier version wrote that this one does not
