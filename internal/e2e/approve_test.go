...
// The listing names the question, the id to answer with, and how long is left
// to do it in.  What --json puts on stdout is cmd/faramir's own test, this one
// covering the op against a live broker.
