...
func TestAnEmptyUserAssignmentClearsTheAccount(t *testing.T) {
	...
	if account, err := unitUser("svc.service"); err == nil {
...
func TestAnAbsentUnitIsReportedAsTheUnit(t *testing.T) {
	unitDirWith(t, nil)
	if _, err := unitUser("svc.service"); err == nil {
...
func TestInstalledAccountsFollowsADropIn(t *testing.T) {
	...
	unitDirWith(t, nil)
	for i, want := range []string{DefaultBrokerUser, DefaultKeeperUser, DefaultExecUser} {
