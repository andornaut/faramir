...
test-unit:
	$(PYTHON) -m unittest tests.test_redact tests.test_allowlist tests.test_protocol tests.test_config tests.test_secretstore tests.test_hook tests.test_sync_git -v
